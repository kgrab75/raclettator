      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className={`p-2.5 rounded-xl transition-colors ${isCompleted ? 'bg-green-500 text-white' : 'bg-amber-500/10 text-amber-600 group-hover:bg-amber-500 group-hover:text-white'}`}>
              <ShoppingBag className="size-5" />
            </div>
            <CardTitle className="text-lg font-bold leading-tight line-clamp-1">{item.name}</CardTitle>
          </div>
